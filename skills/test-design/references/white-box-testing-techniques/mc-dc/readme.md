...
Métrica de cobertura estrutural para software de altíssima confiabilidade que exige demonstrar que cada condição lógica afeta de forma independente o resultado da decisão em que está inserida.
...
[Consulte os outros exemplos de como usar no documento](../../../examples/white-box-testing-techniques/mc-dc/readme.md)
